...
export const emailTranslations = {
  ko: {
    digest: {
      ...
      proOnly: '자막이 없는 영상의 AI 요약은 Pro 플랜에서 제공됩니다.',
      // 자막 확보 실패는 우리 쪽 사정이므로 Pro 유도 문구·요금제 링크를 넣지 않는다.
      failTranscriptFailed: '자막을 불러오지 못해 요약하지 못했습니다.',
      ...
      basisDescription: '영상 설명을 기반으로 분석한 AI 요약입니다. 자막이 없어 원문과 차이가 있을 수 있습니다.',
      basisTranscriptFailed: '자막을 불러오지 못해 영상 설명으로 요약했습니다. 원문과 차이가 있을 수 있습니다.',
      adLabel: '광고',
  ...
  en: {
    digest: {
      ...
      proOnly: 'AI summaries for videos without captions are available on the Pro plan.',
      failTranscriptFailed: 'The transcript could not be retrieved, so this video could not be summarized.',
      basisTranscript: 'Summary generated by AI from the video transcript. It may contain errors.',
      basisDescription: 'Summary generated by AI from the video description. Without a transcript, it may differ from the original.',
      basisTranscriptFailed: 'The transcript could not be retrieved, so this summary was generated from the video description. It may differ from the original.',
      adLabel: 'AD',
  ...
  zh: {
    digest: {
      ...
      failPending: '摘要准备中',
      failLive: '直播视频 · 不提供摘要',
      proOnly: '没有字幕的视频的 AI 摘要在 Pro 计划中提供。',
      failTranscriptFailed: '未能获取字幕，因此未能生成摘要。',
      basisTranscript: '基于字幕分析的 AI 摘要。可能存在错误。',
      basisDescription: '基于视频说明分析的 AI 摘要。由于没有字幕，可能与原文有出入。',
      basisTranscriptFailed: '未能获取字幕，因此根据视频说明生成摘要。可能与原文有出入。',
      adLabel: '广告',
  ...
  ja: {
    digest: {
      ...
      proOnly: '字幕のない動画のAI要約は Pro プランで提供されます。',
      failTranscriptFailed: '字幕を取得できなかったため、要約できませんでした。',
      basisTranscript: '字幕をもとに分析した AI 要約です。誤りが含まれる場合があります。',
      basisDescription: '動画の説明文をもとに分析した AI 要約です。字幕がないため、原文と異なる場合があります。',
      basisTranscriptFailed: '字幕を取得できなかったため、動画の説明文から要約しました。原文と異なる場合があります。',
      adLabel: '広告',
