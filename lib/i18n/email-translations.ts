...
export const emailTranslations = {
  ...
  en: {
    digest: {
      ...
      failLive: 'Live video · Not summarized',
      proOnly: 'AI summaries for videos without captions are available on Pro.',
      failTranscriptFailed: 'A temporary problem prevented this video from being summarized.',
  ...
  zh: {
    digest: {
      ...
      failNoSource: '无法摘要 · 无字幕和说明',
      failTemporary: '摘要失败 · 临时错误',
      failPending: '摘要准备中',
      failLive: '直播视频 · 不提供摘要',
      proOnly: '没有字幕的视频的 AI 摘要在 Pro 中提供。',
      failTranscriptFailed: '由于临时问题未能生成摘要。',
  ...
  ja: {
    digest: {
      ...
      failNoSource: '要約不可 · 字幕・説明なし',
      failTemporary: '要約失敗 · 一時的なエラー',
      failPending: '要約を準備中',
      failLive: 'ライブ動画 · 要約対象外',
      proOnly: '字幕のない動画のAI要約は Pro で提供されます。',
      failTranscriptFailed: '一時的な問題により要約できませんでした。',
