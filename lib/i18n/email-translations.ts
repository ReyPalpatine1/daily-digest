...
export const emailTranslations = {
  ko: {
    digest: {
      ...
      basisDescription: '영상 설명을 기반으로 분석한 AI 요약입니다. 자막이 없어 실제 내용과 차이가 클 수 있습니다.',
  ...
  en: {
    digest: {
      ...
      basisDescription: 'Summary generated by AI from the video description. Without a transcript, it may differ significantly from the actual content.',
      basisTitle: 'Summary generated by AI from the video title. It may differ significantly from the actual content.',
      adLabel: 'AD',
  ...
  zh: {
    digest: {
      ...
      basisDescription: '基于视频说明分析的 AI 摘要。由于没有字幕，可能与实际内容有较大出入。',
      basisTitle: '基于视频标题分析的 AI 摘要。可能与实际内容有较大出入。',
      adLabel: '广告',
  ...
  ja: {
    digest: {
      ...
      basisDescription: '動画の説明文をもとに分析した AI 要約です。字幕がないため、実際の内容と大きく異なる場合があります。',
      basisTitle: '動画のタイトルをもとに分析した AI 要約です。実際の内容と大きく異なる場合があります。',
      adLabel: '広告',
