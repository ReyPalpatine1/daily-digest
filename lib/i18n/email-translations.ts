...
export const emailTranslations = {
  ko: {
    digest: {
      ...
      failPreparing: '요약 준비 중 — 완료되면 열람 기록에 반영됩니다.',
      failUnavailable: '요약 제공 불가',
  ...
  en: {
    digest: {
      ...
      failPreparing: 'Summary in progress — it will appear in your history once ready.',
      failUnavailable: 'Summary unavailable',
  ...
  zh: {
    digest: {
      ...
      failPreparing: '摘要准备中 — 完成后会反映到记录中。',
      failUnavailable: '无法提供摘要',
  ...
  ja: {
    digest: {
      ...
      failPreparing: '要約を準備中 — 完了すると記録に反映されます。',
      failUnavailable: '要約を提供できません',
