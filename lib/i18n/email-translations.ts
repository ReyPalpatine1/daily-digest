...
export const emailTranslations = {
  ko: {
    digest: {
      ...
      basisTranscript: '자막을 기반으로 분석한 AI 요약이라 오류가 있을 수 있습니다.',
      basisDescription: '영상 설명을 기반으로 분석한 AI 요약이라, 자막이 없어 실제 내용과 차이가 클 수 있습니다.',
      // 제목 기반은 폐지된 요약 방식 — 과거 데이터 호환용으로만 남긴다.
      basisTitle: '영상 제목을 기반으로 분석한 AI 요약이라 실제 내용과 차이가 클 수 있습니다.',
      adLabel: '광고',
  ...
  en: {
    digest: {
      ...
      basisTranscript: 'An AI summary analyzed from the transcript, so it may contain errors.',
      basisDescription: 'An AI summary analyzed from the video description, so with no transcript available it may differ significantly from the actual content.',
      basisTitle: 'An AI summary analyzed from the video title, so it may differ significantly from the actual content.',
      adLabel: 'AD',
  ...
  zh: {
    digest: {
      ...
      basisDescription: '基于视频说明分析的 AI 摘要，由于没有字幕，可能与实际内容差异较大。',
  ...
  ja: {
    digest: {
      ...
      basisTranscript: '字幕をもとに分析したAI要約のため、誤りが含まれる場合があります。',
      basisDescription: '動画の説明をもとに分析したAI要約のため、字幕がなく実際の内容と大きく異なる場合があります。',
      basisTitle: '動画のタイトルをもとに分析したAI要約のため、実際の内容と大きく異なる場合があります。',
      adLabel: '広告',
