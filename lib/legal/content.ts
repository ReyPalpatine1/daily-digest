...
제5조(환불 절차) 1. 환불 요청은 서비스 내 환불 기능 또는 support@dailyvideodigest.com으로 접수할 수 있습니다. 2. 서비스 내 환불 기능을 통한 요청이 제3조의 요건을 충족하는 경우, 회사는 이를 즉시 처리하고 결제대행사(PG)에 결제 취소를 요청합니다. 3. 그 밖의 요청에 대하여 회사는 접수일로부터 3영업일 이내에 환불 사유를 확인하고, 결제수단 및 결제대행사(PG)의 정책에 따라 결제 취소 또는 환불 절차를 진행합니다.
